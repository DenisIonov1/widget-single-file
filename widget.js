    ...
    wrapper.innerHTML = `
        <div class="n7-widget__body">
            ...
            <div class="n7-suggestions-list">
                <button type="button" class="n7-suggestions-list__item" id="learn-more" data-message="Узнать больше о ЖК">Узнать
                    больше о ЖК</button>
                <button type="button" class="n7-suggestions-list__item" id="learn-flats"
                    data-message="Узнать больше о квартирах в ЖК">Узнать
        ...
        <div class="n7-footer">
            <form action="#" class="n7-form">
                <textarea placeholder="Сообщение" class="n7-input" maxlength="600"></textarea>
                <button id="send-message" type="submit" class="n7-submit">
